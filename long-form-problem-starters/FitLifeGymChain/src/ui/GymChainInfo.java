...
public class GymChainInfo {
    ...
    public static final String GOLDS_GYM = "Gold's Gym";
    public static final String NICK_MEMBER_NAME = "Nick Hopewell";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(NICK_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym golds = new Gym(GOLDS_GYM);
        initializeGym0(golds);
        chain.addGym(golds);
    }
