...
public class InfoManager {
    ...
    private static final String YOUR_GYM_COMMAND = "golds";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + YOUR_GYM_COMMAND + "' for Fitlife " + GOLDS_GYM);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case YOUR_GYM_COMMAND:
                    printGymInfo(chain.lookupGymByName(GOLDS_GYM));
                    break;
